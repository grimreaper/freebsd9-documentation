...
# $Id: stage_1.sh,v 1.1.1.1.2.2 2006/03/13 15:03:02 rushani Exp $
# $FreeBSD: doc/ja_JP.eucJP/articles/fbsd-from-scratch/stage_1.sh,v 1.2 2006/03/13 16:46:15 rushani Exp $
