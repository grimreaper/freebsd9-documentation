...
# $FreeBSD: ports/Tools/scripts/mark_safe.pl,v 1.9 2010/09/23 17:22:45 pgollucci Exp $
#
...
### version
our $VERSION = do { my @r = (q$FreeBSD: ports/Tools/scripts/mark_safe.pl,v 1.9 2010/09/23 17:22:45 pgollucci Exp $ =~ /\d+/g); sprintf "%d." . "%02d" x $#r, @r };
